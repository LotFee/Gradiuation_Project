...
class UpdatePost extends StatefulWidget {
  ...
  static const String routeName = 'Update Post';
 ...
 String description = '';
              ...
              children: [
                ...
                Container(
                  ...
                  child: Container(
                    color: Colors.white,
                    child: TextFormField(
                      initialValue: flatItem.price.toString(),
                     // controller: price,
                ...
                Container(
                  ...
                  child: Container(
                    color: Colors.white,
                    child: TextFormField(
                       initialValue: flatItem.location.toString(),
                      onChanged: (v){
                         setState(() {
                           location=v;
                           print(v);
                ...
                Container(
                  ...
                  child: Container(
                    color: Colors.white,
                    child: TextFormField(
                       initialValue: flatItem.bedrooms.toString(),
                      onChanged: (v){
                         setState(() {
                           nonoBedroom=int.parse(v);
                         });
                      },
                      textInputAction: TextInputAction.next,
                      keyboardType: TextInputType.number,
                ...
                Container(
                  ...
                  child: Container(
                    color: Colors.white,
                    child: TextFormField(
                      initialValue: flatItem.bed.toString(),
                      onChanged: (v){
                        setState(() {
                          noBed=int.parse(v);
                        });
                ...
                Container(
                  ...
                  child: Container(
                    color: Colors.white,
                    child: TextFormField(
                     initialValue: flatItem.description,
                      onChanged: (v){
                       setState(() {
                         description=v;
                       });
                    ...
                    child: GestureDetector(
                      onTap: (){
                        if(validate()){
                          ...
                          print(noBed);
                          print(nonoBedroom);
                         update(price: price!, location: location!, nobeds: noBed!, nobedrooms: nonoBedroom!, wifi: wifi, tv: tv, cond: cond, desc: description , imagesList:imagesFile );
                        }
                      },
                      child: ListTile(
                        leading: Icon(
  ...
  Future<void> update({
    ...
    try {
      ...
      var uri = Uri.parse('https://afternoon-ridge-73830.herokuapp.com/updatePost/${flatid}/${currentuser.currentUserDate.id}');
